...
| :small_red_triangle: [WeLeakInfo](https://weleakinfo.com/) - Public                 |                Number of search-able breach results               |  :white_check_mark: :key:  |
| :small_red_triangle: [WeLeakInfo](https://weleakinfo.com/) - Service                |    Cleartext passwords, hashs and salts, usernames, IPs, domain   |  :white_check_mark: :key:  |
